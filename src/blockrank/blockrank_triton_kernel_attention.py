...
def triton_blockrank_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    block_order = getattr(cfg, "blockrank_block_order", "instruction_first") if cfg is not None else "instruction_first"
    doc_cross_attn = getattr(cfg, "blockrank_doc_cross_attn", False) if cfg is not None else False
    if block_order != "instruction_first" or doc_cross_attn:
        raise NotImplementedError("triton_blockrank only supports instruction_first with doc_cross_attn=False")
